<script lang="ts">
	...
	import Scorers from '$lib/Scorers.svelte';
	...
	<Box>
		<h2 class="mb-4 flex items-center text-xl font-bold text-gray-800">
			...
			>
				<g>
					<path
						d="M412.919,275.764l1.261,1.897l-11.238,34.402l-63.576,20.792l-37.112-27.064v-29.754
		...
		l-38.531-54.075l14.238-43.56l63.602-20.8l29.049,21.065C435.466,346.062,435.634,348.734,435.634,351.461z"
					/>
					<path
						class="st0"
						d="M373.514,119.609l-1.508,2.258l-19.222,19.213c-3.644,3.652-9.545,3.652-13.197,0
		...
		l-48.438-65.745h27.073l48.438,65.745H208.546z M266.555,203.94l-48.438-65.745h27.081l48.429,65.745H266.555z"
					/>
				</g>
			</svg>
			Scorers
